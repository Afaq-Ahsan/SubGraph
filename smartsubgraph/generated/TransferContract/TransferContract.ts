...
export class changeIdEvent extends ethereum.Event {
  get params(): changeIdEvent__Params {
    return new changeIdEvent__Params(this);
  }
}

export class changeIdEvent__Params {
  _event: changeIdEvent;

  constructor(event: changeIdEvent) {
    this._event = event;
  }
...
export class tranferEvent extends ethereum.Event {
  get params(): tranferEvent__Params {
    return new tranferEvent__Params(this);
  }
}

export class tranferEvent__Params {
  _event: tranferEvent;

  constructor(event: tranferEvent) {
    this._event = event;
  }
